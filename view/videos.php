<?php include_once("header.php");?>
    ...
    <link rel="stylesheet" href="lib/plyr/dis/plyr.css">
    ...
    <section>
            ...
            <div id="call-to-action">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <!-- link para videos e legendas: https://github.com/sampotts/plyr -->
                        ...
                        <!-- <audio src="mp3/teste.mp3" controls></audio> -->
            ...
            <div id="news" class="container" style="top:0">
                   ...
                   <div class="row text-center">
                    ...
                    <div class="row thumbnails owl-carousel theme">
                    <!-- <div class="row thumbnails"> -->
                        ...
                        <div class="item" data-video="Orlando_City_Foundation_2015">
                            <div class="item-inner">                        
                                ...
                                <h3>2 Orlando City Foundation 2015</h3>
...
<?php include_once("footer.php");?>
    ...
    <script>
        $(function(){
            ...
            plyr.setup();//dispara o player do plyr
